...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--train_changed_pct', type=float, default=0.3, 
    ...
    parser.add_argument('--test_changed_modal', type=str, default='language', 
                            help='Control the modality of change during training, one of {language, video, audio}')
    parser.add_argument('--test_changed_pct', type=float, default=0.3, 
    ...
    parser.add_argument('--lora_alpha', type=int, default=16,
                        help='LoRA scaling parameter (alpha/rank)')
    parser.add_argument('--lora_dropout', type=float, default=0.1,
                        help='Dropout rate for LoRA layers')
    parser.add_argument('--train_only_lora', type=str2bool, default=False,
                        help='Freeze all weights except LoRA parameters')
    parser.add_argument('--merge_lora_at_end', type=str2bool, default=False,
                        help='Merge LoRA weights into main weights after training')

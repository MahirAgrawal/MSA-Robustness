...
class MOSI:
    def __init__(self, config):
        ...
        CACHE_PATH = DATA_PATH + '/misa_embedding_and_mapping.pt'
        ...
        try:
            ...
            # Save pickles
            to_pickle(train, DATA_PATH + '/misa_train.pkl') 
            to_pickle(dev, DATA_PATH + '/misa_dev.pkl')
            to_pickle(test, DATA_PATH + '/misa_test.pkl')
